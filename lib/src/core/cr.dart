...
import 'package:cr/src/core/theme/app_theme.dart';
...
import 'package:cr/src/shared/transalation/logic/repository/language_repository.dart';
...
class Cr extends StatelessWidget {
  ...
  const Cr({super.key, AppRouter? appRouter}) : _providedRouter = appRouter;
